...
startEnv = [ (intern "putChr", Lambda [varX] $ Apply [Builtin PutChr, Var varX])
           ...
           , (intern "_cons_", Lambda [varX, varY] $ Apply [Builtin ConsSeq, Var varX, Var varY])
           , (intern "_snoc_", Lambda [varX, varY] $ Apply [Builtin SnocSeq, Var varX, Var varY])
           , (intern "_cat_", Lambda [varX, varY] $ Apply [Builtin CatSeq, Var varX, Var varY])
